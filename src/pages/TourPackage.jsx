...
function TourPackage() {
  return (
    ...
    <>
        <div className="container tourpackage-head d-flex justify-content-between align-items-center " style={{marginTop:75}}>
            <div className="north">
                <h1>North India Group Tour Package</h1>
            </div>

            <div className="view-btn-d">
        ...
        <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
                ...
                <a href="#" className="btn btn-primary-explor">Explor More</a>
            </div>
        </div>
        <div className="card" style={{width: '18rem'}}>
        ...
        <div className="container tourpackage-head d-flex justify-content-between align-items-center" style={{marginTop:75}}>
            <div className="north">
                <h1>South India Group Tour Package</h1>
            </div>
        ...
        <div className="container tourpackage-head d-flex justify-content-between align-items-center" style={{marginTop:75}}>
            <div className="north">
                <h1>West India Group Tour Package</h1>
            </div>
        ...
        <div className="container tourpackage-head d-flex justify-content-between align-items-center" style={{marginTop:75}}>
            <div className="north">
                <h1>East India Group Tour Package</h1>
            </div>
